...
class Cards extends Component {
  ...
  // render() {
  //   const cardvalue = this.state.cardobject.map((obj) => {
  //     return<>
  ...
  // }
  render() {
    const cardvalue = this.state.cardobject.map((obj,index) => {
      return (
        <>
          <div key={obj.name  || index} className="cards">
            <img src={obj.img} alt=""></img>
            <h2>{obj.name}</h2>
            <div className="flex-jcsb-aic card-kg pad-rl-20">
              <p>{obj.kilogram}g</p>
